...
class DatabaseService {
   ...
   * @returns {Promise<{dbId: string, packageData: Object} | null>} - Matching package data and database ID, or null if not found
   */
  /**
   ...
   * @returns {Promise<{dbId: string, packageData: Object} | null>} - Matching package data and database ID, or null if not found
   */
  static async getActiveFeedbackPackageForUrl(currentUrl) {
    if (!currentUrl) {
