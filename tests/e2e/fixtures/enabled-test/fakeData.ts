      ...
      objectStores: [
        ...
        },
        {
          ...
          data: [
            ...
            {
              timestamp: 1751984603910,
              xpath: '/html/body/img',
              elementText: '',
              feedback: 'feedback on the flow diagram',
              pageUrl: '/tests/e2e/fixtures/enabled-test/enabled/index.html',
              documentTitle: 'BackChannel Enabled Test - Enabled Root',
            },
            {
              timestamp: 1751984614621,
              xpath: '/html/body/p[6]',
              elementText: 'Collaborative feedback process',
              feedback: 'feedback on last paragraph',
              pageUrl: '/tests/e2e/fixtures/enabled-test/enabled/index.html',
              documentTitle: 'BackChannel Enabled Test - Enabled Root',
            },
          ],
